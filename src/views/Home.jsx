...
import resume from "../assets/Balaji-resume.pdf";
    ...
    >
      ...
      >
        <div className="text-center">
          ...
          <span class="text-gray-100 animate-pulse animate-infinite transform transition-transform hover:scale-110">Hi, I'm Balaji V</span>
          ...
          >
            I love techie stuff and curious to learn new technologies...
          </p>
          <Social />
          ...
          <div className="mt-8 flex justify-center">
            <a
              ...
              className="cursor-pointer relative border font-bold focus:ring-4 focus:outline-none focus:ring-blue-300 text-gray-100 bg-blue-500 hover:bg-gray-100 hover:text-blue-500 rounded-xl md:text-xl py-2 px-4 md:py-4 md:px-8 flex items-center **transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-lg hover:text-white**"
            >
