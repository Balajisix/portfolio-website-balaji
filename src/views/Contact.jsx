      ...
      <div className="max-w-7xl mx-auto x-4 sm:px-6 lg:px-8 px-4 ">
        ...
        <div className="flex justify-between items-center md:items-stretch  flex-col md:flex-row pb-24">
          <div className="w-full md:pr-8">
            <form
              action="mailto:balajivs0305@gmail.com"
              method="post"
              enctype="text/plain"
            >
              <div class="my-6">
              ...
              <div className="flex justify-between ">
                <div className="underline">
                  <a href="mailto:balajivs0305@gmail.com">
          ...
          <div className="w-full flex flex-col md:items-end  mt-12 md:mt-6">
            ...
            <p className="mb-12 mt-4 font-semibold md:text-right ">
              Feel free to reach me through the social media links and I'm interested to collaborate with new people to gain, explore, and share the intuitive ideas and let's build the project togather.
            </p>
